...
**El formulario público tiene tres frenos, y ninguno alcanza solo.** El campo trampa
atrapa al bot tonto. El límite por IP (`ratelimits` en `wrangler.jsonc`) frena al que
