...
// Trazos sueltos, sin relleno. Heredan el color del contenedor via `currentColor`.
const TRAZOS: Record<ValorIcono, string> = {
  ...
  termometro: '<path d="M14 14.8V4a2 2 0 0 0-4 0v10.8a4 4 0 1 0 4 0"/>',
  ducto: '<rect x="3" y="4" width="18" height="6" rx="1"/><rect x="3" y="14" width="18" height="6" rx="1"/><path d="M7 10v4M17 10v4"/>',
...
export default function Icono({ nombre = 'aire', clase = 'size-6' }: Props) {
  return (
    <svg
      className={clase}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
      dangerouslySetInnerHTML={{ __html: TRAZOS[nombre] ?? TRAZOS.aire }}
    />
  );
}
