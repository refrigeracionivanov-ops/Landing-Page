    ...
    <section className="relative min-h-[88svh] flex items-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8 py-24 w-full">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <a href="#ca-agendar" className="ca-boton inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-7 py-3.5 rounded-lg text-base">
          ...
          {bloque.mostrarBotonWhatsapp !== false && (
            <a href={wa} target="_blank" rel="noopener" className="ca-boton inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white font-semibold px-7 py-3.5 rounded-lg text-base border border-white/30">
