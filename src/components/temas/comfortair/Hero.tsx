      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8 py-24 w-full">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          {bloque.mostrarBotonWhatsapp !== false && (
            <a href={wa} target="_blank" rel="noopener" className="ca-boton inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-900 font-semibold px-7 py-3.5 rounded-lg text-base">
